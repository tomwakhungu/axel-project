            ...
            <form method="POST" action="" enctype="multipart/form-data" style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="state" name="state" required value="<?php echo htmlspecialchars($property['state']); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="amenities" id="amenities" style="min-height: 80px;"><?php echo htmlspecialchars($property['amenities']); ?></textarea>
                </div>
